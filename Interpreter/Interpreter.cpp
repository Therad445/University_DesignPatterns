...
// Допы:
//  чтобы один Enter оставался при удалении нескольких, в таком случае абзац начинается с красной строки (tab)
//  Обработка по примеру "ctfcf.bgbyg" -> "ctfcf. Bgbyg" для ".","!", "?" 
